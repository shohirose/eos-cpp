...
namespace eos
{
  ...
  private:
    ...
    double beta_; /// The derivative of temperature correction factor for attraction parameter
  };
  ...
  public:
    ...
    /// @param[in] p Pressure
    /// @param[in] t Temperature
    isobaric_isothermal_state<Derived> create_isobaric_isothermal_state(double p, double t) const noexcept
    {
  ...
  private:
    ...
    /// @param[in] p Pressure
    double reduced_pressure(double p) const noexcept
    {
      return p / pc_;
    }
    ...
    /// @param[in] t Temperature
    double reduced_temperature(double t) const noexcept
    {
      return t / tc_;
    }
